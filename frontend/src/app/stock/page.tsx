...
function TabHistorial({ ingredientes }: { ingredientes: Ingrediente[] }) {
  ...
  // Editing a manual count triggers a real ledger adjustment (PUT /api/inventario/{id}),
  ...
  const iniciarEdicion = (registro: RegistroStock) => {
    setEditando({ id: registro.id, value: String(registro.cantidad), original: registro.cantidad, unidad: registro.unidad });
  };
